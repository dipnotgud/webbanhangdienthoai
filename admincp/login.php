<?php
    ...
    if(isset($_POST['login'])){
        ...
        $sql_account="SELECT * FROM tbl_admin WHERE username='".$username."' AND password='".$password."' ";
    ...
    if(isset($_POST['create_account'])){
        ...
        if($new_username!=''&&$new_password!=''&&$new_password==$new_password_retype){
            $sql_create_account="INSERT INTO tbl_admin(username,password,admin_status) VALUES('".$new_username."','".$new_password."','1')";
