                    ...
                    <div class="col l-3 pay">
                        <div>
                            <div class="detail">
                                ...
                                <p class="gif">Phần thưởng <strong class="point_number"><?php echo number_format($total / 10000, 0, ',', '.') ?></strong> điểm DD_PH Store</p>
                                ...
                                <p class="pay_p">Dùng Mã giảm giá, Điểm DD_PH Store trong bước tiếp theo</p>
                            </div>
                            <div>
